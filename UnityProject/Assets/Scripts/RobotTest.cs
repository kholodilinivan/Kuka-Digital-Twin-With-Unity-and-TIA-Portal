...
public class RobotTest : MonoBehaviour
{
    ...
    {   // angles
        ...
        // position
        Xstring.text = (EndEffector.transform.position.z - BaseOrigin.transform.position.z).ToString();
        Ystring.text = (EndEffector.transform.position.x - BaseOrigin.transform.position.x).ToString();
        Zstring.text = (EndEffector.transform.position.y - BaseOrigin.transform.position.y).ToString();        
    }
}
